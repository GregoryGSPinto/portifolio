...
const links: LinkItem[] = [
  {
    id: 'email-outlook',
    label: { pt: 'Email (Outlook)', en: 'Email (Outlook)' },
  ...
  {
    id: 'email-gmail',
    label: { pt: 'Email (Gmail)', en: 'Email (Gmail)' },
...
export default function SocialLinks() {
  ...
  return (
    ...
    >
      {links.map((link) => {
        const resolvedHref = typeof link.href === 'function' ? link.href(lang) : link.href;
        return (
        <motion.div
          key={link.id}
          variants={fadeInUp}
        ...
        >
          <a
            href={resolvedHref}
            target={resolvedHref.startsWith('mailto:') || resolvedHref.startsWith('tel:') ? undefined : '_blank'}
