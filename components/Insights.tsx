    ...
    <section id="insights" className="py-20 md:py-28 lg:py-40 relative">
      <div className="max-w-[1200px] mx-auto px-5 md:px-8 lg:px-12">
        ...
        <motion.p
          ...
          className="max-w-2xl mb-10 text-base leading-relaxed"
          style={{ color: 'var(--text-secondary)' }}
        >
          {lang === 'pt'
            ? 'Artigos usados para mostrar como penso, decido e estruturo software. Menos opiniao vaga, mais criterio tecnico aplicado.'
            : 'Articles used to show how I think, decide, and structure software. Less vague opinion, more applied technical judgment.'}
        </motion.p>
