  ...
  return (
    <div className="flex items-center gap-4">
      <span
        ...
        style={{ minWidth: '130px', color: 'rgba(232, 228, 222, 0.5)' }}
      >
        {name}
      </span>
      <div className="flex-1 h-[3px] rounded-full" style={{ background: 'rgba(255, 255, 255, 0.06)' }}>
        <div
          ...
          style={{
            ...
            background: 'linear-gradient(90deg, #C9A84C, #C9A84C88)',
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12" ref={ref}>
        ...
        >
          {categories.map(([key, category]) => (
            ...
            >
              <h3
                className="font-mono text-[11px] uppercase tracking-[3px] mb-8"
